...
The project combines **SQL for data analysis** and **Power BI for interactive dashboards**, making it suitable for business stakeholders and decision-makers.
 🎯 Objectives
- Identify high-revenue products with stock availability issues
- Analyze supplier performance based on lead time, cost, and defect rates
...
- Shipping modes, routes, and costs
- Quality inspection results and defect rates
**Data Source:** Internal supply chain database  
**Database:** MySQL  
 🛠️ Tools & Technologies
- **SQL (MySQL)** – Data extraction and diagnostic analysis
...
- Relationship between manufacturing cost and defect rates
...
3. **Supplier Insight Dashboard** – Supplier performance and logistics evaluation

The dashboard provides interactive filters for product type, SKU, supplier name, and transportation mode.
 🔍 Key Findings
- Revenue is concentrated in a limited number of SKUs and product types
- Several products face demand exceeding available stock
...
- Optimize transportation mode selection to reduce cost and defects
